...
[![Build Status](https://github.com/yevgen4989/mariadb/workflows/Build%20docker%20image/badge.svg)](https://github.com/yevgen4989/mariadb/actions)
[![Docker Pulls](https://img.shields.io/docker/pulls/yevgen4989/mariadb.svg)](https://hub.docker.com/r/yevgen4989/mariadb)
[![Docker Stars](https://img.shields.io/docker/stars/yevgen4989/mariadb.svg)](https://hub.docker.com/r/yevgen4989/mariadb)

## Docker Images

❗For better reliability we release images with stability tags (`yevgen4989/mariadb:10.4-X.X.X`) which correspond to [git tags](https://github.com/yevgen4989/mariadb/releases). We strongly recommend using images only with stability tags.

Overview:

- All images based on Alpine Linux
- Base image: [yevgen4989/alpine](https://github.com/yevgen4989/alpine)
- [GitHub actions builds](https://github.com/yevgen4989/mariadb/actions)
- [Docker Hub](https://hub.docker.com/r/yevgen4989/mariadb)

Supported tags and respective `Dockerfile` links:

- `10.6`, `10`, `latest` [_(Dockerfile)_](https://github.com/yevgen4989/mariadb/tree/master/10/Dockerfile)
- `10.5` [_(Dockerfile)_](https://github.com/yevgen4989/mariadb/tree/master/10/Dockerfile)
- `10.4` [_(Dockerfile)_](https://github.com/yevgen4989/mariadb/tree/master/10/Dockerfile)
- `10.3` [_(Dockerfile)_](https://github.com/yevgen4989/mariadb/tree/master/10/Dockerfile)
- `10.2` [_(Dockerfile)_](https://github.com/yevgen4989/mariadb/tree/master/10/Dockerfile)
...
| [`MYSQL_INNODB_STRICT_MODE`]             | `ON`                 | `ON`               | `ON`              | `ON`              |
...
$ docker run -e WSREP_ON=ON -v data1:/var/lib/mysql --name galera-1 \
    yevgen4989/mariadb:galera --wsrep-new-cluster
```
...
$ docker run -e WSREP_ON=ON -v data2:/var/lib/mysql --name galera-2 \
    yevgen4989/mariadb:galera --wsrep-cluster-address="gcomm://<node-1>"
```
```
$ docker run -e WSREP_ON=ON -v data3:/var/lib/mysql --name galera-3 \
    yevgen4989/mariadb:galera --wsrep-cluster-address="gcomm://<node-1>,<node-2>"
```
...
```
$ docker run yevgen4989/mariadb:galera garbd --help
